  ...
  for (let i = 0; i < array.length; i++) {
    for (let j = 0; j < array.length - i - 1; j++) {
      ...
      for (let k = 0; k < box.length; k++) {
        // if(k!==j && k!==j+1){
        box[k].style.backgroundColor = "#5ec576";
      }
    }
...
async function heapBox(array, n, i) {
  ...
  if (left < array.length) box[left].style.backgroundColor = "pink";

  if (right < array.length) box[right].style.backgroundColor = "pink";
  ...
  if (left < array.length) box[left].style.backgroundColor = "#5ec576";

  if (right < array.length) box[right].style.backgroundColor = "#5ec576";
}
...
async function qswapBox(array, leftIndex, rightIndex, box) {
  ...
  box[leftIndex].style.backgroundColor = "#5ec576";
  box[rightIndex].style.backgroundColor = "#5ec576";
}
